...
public $Blocks = [
  ...
  public $Ores = [
    "ICON" => ["Ores",266,0],
    "Coal" => [263,0,100,0],
    "Iron Ingot" => [265,0,1000,0],
    "Gold Ingot" => [266,0,800,0],
    "Diamond" => [264,0,1250,0]
  ];
  ...
  public $Spawner = [
    "ICON" => ["Spawner",368,0],
	"Mob Spawner" => [52,0,1250000,0],
	"Iron Golem Egg" => [322:20,0,235000,0],
	"Blaze Egg" => [322:43,0,235000,0],
    "Zombie Egg" => [322:32,0,235000,0],
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§eShop","       §cPurchase and Sell items Here!");
  ...
  public function sendShop(Player $player, $id){
    $ui = new SimpleForm("§cShop","       §ePurchase and Sell items Here!");
    $ids = -1;
    foreach($this->item as $category){
      $ids++;
      $rawitemdata = $category["ICON"];
